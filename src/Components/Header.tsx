...
const Header:React.FC = () => {
  ...
  return (
    <div className='w-screen font-DmSans top-[10%] flex justify-evenly absolute md:top-[10%]'>
        <Logo variant='slider'/>
        <div className='hidden md:w-[30vw] h-[2vw]  border border-white rounded-md md:flex'><input ref={searchRef} className='w-[90%] bg-transparent placeholder:text-white placeholder:font-DmSans focus:outline-none border-r border-r-white px-2 text-white ' placeholder='What are you interested in?' type="search" name="" id="" onChange={handleChange} /> <div className='text-white flex w-[10%] justify-center items-center '><AiOutlineSearch size={15}/></div></div>
